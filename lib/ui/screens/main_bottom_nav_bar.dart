    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.free_cancellation_rounded),label: 'Cancelled'),
          BottomNavigationBarItem(icon: Icon(Icons.incomplete_circle_outlined),label: 'Progress'),
        ],
      ),
    );
  }
